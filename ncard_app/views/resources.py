...
from ncard_app.models import (Award, Event, Grant, Organisation, Person,
                              Project, Publication, Students, Department)
...
class PersonResource(resources.ModelResource):
    ...
    department_primary = fields.Field(
        column_name='department_primary',
        attribute='department_primary',
    ...
    department_other = fields.Field(
        column_name='department_other',
        attribute='department_other',
        widget=ForeignKeyWidget(Department, 'id'
                                )
    )
    title = fields.Field(
...
class GrantResource(resources.ModelResource):
    ...
    class Meta:
        model = Grant
        export_order = (
        'id', "title", "grant_reference", "roap_reference", 'agency', "project", 'status', 'investigators',
        'year_submitted', 'year_start', 'year_end', 'bu_no', 'pg_no', 'total_request', 'total_award')
